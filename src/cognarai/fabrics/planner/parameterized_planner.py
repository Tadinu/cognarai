...
from cognarai.fabrics.components.energies.execution_energies import ExecutionLagrangian
from cognarai.fabrics.components.leaves.attractor import GenericAttractor
from cognarai.fabrics.components.leaves.dynamic_attractor import GenericDynamicAttractor
from cognarai.fabrics.components.leaves.dynamic_geometry import (
    DynamicObstacleLeaf, GenericDynamicGeometryLeaf)
from cognarai.fabrics.components.leaves.geometry import (AvoidanceLeaf,
                                                CapsuleCuboidLeaf,
                                                CapsuleSphereLeaf,
                                                ESDFGeometryLeaf,
                                                ...
                                                SelfCollisionLeaf,
                                                SphereCuboidLeaf)
from cognarai.fabrics.components.leaves.leaf import Leaf
from cognarai.fabrics.diff_geometry.diff_map import (DifferentialMap,
                                          DynamicDifferentialMap)
from cognarai.fabrics.diff_geometry.energized_geometry import WeightedGeometry
from cognarai.fabrics.diff_geometry.energy import Lagrangian
from cognarai.fabrics.diff_geometry.geometry import Geometry
from cognarai.fabrics.diff_geometry.speed_control import Damper
from cognarai.fabrics.helpers.casadi_func_wrapper import CasadiFunctionWrapper
from cognarai.fabrics.helpers.constants import eps
from cognarai.fabrics.helpers.exceptions import ExpressionSparseError
from cognarai.fabrics.helpers.functions import is_sparse, parse_symbolic_input
from cognarai.fabrics.helpers.geometric_primitives import Sphere
from cognarai.fabrics.helpers.variables import Variables
from cognarai.fabrics.planner.configuration_classes import (FabricPlannerConfig,
...
class ParameterizedFabricPlanner(object):
    ...
    def add_leaf(self, leaf: Leaf, prime_leaf: bool = False) -> None:
        if isinstance(leaf, GenericAttractor):
            ...
            self.add_dynamic_forcing_geometry(leaf.map(), leaf.dynamic_map(), leaf.lagrangian(), leaf.geometry(),
                                              leaf._xdot_ref, prime_leaf)
            ...
            self.add_dynamic_geometry(leaf.map(), leaf.dynamic_map(), leaf.geometry_map(), leaf.lagrangian(),
                                      leaf.geometry())
