"""
Source: https://github.com/UM-ARM-Lab/pytorch_mppi
"""
import logging
import time
import typing
...
class BaseMPPI():
    ...
    def __init__(self, dynamics, running_cost, nx, noise_sigma, num_samples=100, horizon=15, device="cpu",
        ...
        U_init = [[0.0] * len(self.noise_mu)] * horizon
        self.U = torch.tensor(U_init, dtype=dtype, device=device)
    ...
    def _compute_rollout_costs(self, perturbed_actions):
        ...
        for t in range(T):
            ...
            next_state, u = self._dynamics(state, u, t)
