    ...
    def __init__(self):
        ...
        self.USD_PATHS: Dict[str, str] = {model_name: f"{IsaacCommon.NUCLEUS_ASSETS_DIR}/{usd_path}"
                                                      ...
                                                      for model_name, usd_path in
            {
                ...
                UR10_MODEL: "Robots/UniversalRobots/ur10/ur10.usd",
                UR10_WITH_LONG_SUCTION_MODEL: "Robots/UniversalRobots/ur10/ur10.usd",
                UR10_WITH_SHORT_SUCTION_MODEL: "Robots/UniversalRobots/ur10/ur10.usd",
