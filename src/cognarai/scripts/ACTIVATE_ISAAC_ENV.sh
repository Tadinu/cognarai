...
# EXTSCACHE
export PYTHONPATH=$PYTHONPATH:$ISAACSIM_EXTS_CACHE/omni.replicator.core-1.11.14+106.0.1.lx64.r.cp310:$ISAACSIM_EXTS_CACHE/omni.graph.scriptnode-1.19.1+106.0.0:$ISAACSIM_EXTS_CACHE/omni.kit.window.material_graph-1.8.15
...
# USD libs
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$ISAACSIM_KIT_EXTS/omni.usd.libs/bin:$ISAACSIM_KIT_EXTS/omni.usd.schema.audio/bin:$ISAACSIM_KIT_EXTS/omni.usd.schema.semantics/bin:$ISAACSIM_EXTS_PHYSICS/omni.usd.schema.physx/bin
