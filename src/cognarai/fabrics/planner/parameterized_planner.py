...
@deprecation.deprecated(details="Remove the goal attribute angle and rotate the position before passing it into compute_action.")
...
class ParameterizedFabricPlanner(object):
    ...
    def serialize(self, file_name: str):
        ...
        Essentially, only the casadi_func_wrapper is serialized using
        pickle.
        """
