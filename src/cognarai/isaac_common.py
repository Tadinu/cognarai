...
class IsaacCommon(object, metaclass=Singleton):
    ...
    def __init__(self):
        ...
        from pycram.external_interfaces.isaac.pr2 import PR2
        from pycram.external_interfaces.isaac.panda import Panda
        from pycram.external_interfaces.isaac.ur10 import UR10
        from .ur5 import UR5
